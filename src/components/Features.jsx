    ...
    useGSAP(() => {
        gsap.to('#exploreVideo', {
            scrollTrigger: {
                ...
                toggleActions: 'play pause reverse restarts'
            },
            start: "-10% bottom",
            onComplete: () => {
            ...
            <div className='screen-max-width'>
                ...
                <div className='flex-col flex-center sm:px-10'>
                    <div className='relative h-[50vh] w-full flex items-center'>
                        <video ref={videoRef} preload='none' muted autoPlay playsInline id='exploreVideo' className='object-cover object-center w-full h-full'>
                            <source src={exploreVideo} type='video/mp4' />
                        </video>
                    </div>
                    <div className='relative flex flex-col w-full'>
                        <div className='mt-6 feature-video-container'>
